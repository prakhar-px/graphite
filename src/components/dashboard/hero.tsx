        ...
        >
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-3 md:mt-8">
            ...
            <button
              ...
              className={cn(
                "rounded-2xl border border-zinc-800 bg-zinc-950/50 p-4 text-left transition",
                "hover:border-violet-500/40 hover:bg-zinc-900/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/50"
              )}
            >
